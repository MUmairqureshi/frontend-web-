      ...
      <div className="self-stretch rounded-t-none rounded-b-3xs bg-primary-contrast flex flex-col py-5 px-4 items-center justify-center border-[1px] border-solid border-whitesmoke">
        <div className="self-stretch flex flex-row items-center justify-start">
          <div className="flex-1 flex flex-col items-start justify-start gap-[3px]">
            <div className="self-stretch relative text-xl tracking-[0.02em] font-medium font-components-input-label text-darkslategray-200 text-left">
              {destinationName}
            </div>
            <div className="self-stretch relative text-base tracking-[0.02em] font-components-input-label text-darkgray text-left">
              {packageDuration}
            </div>
          </div>
